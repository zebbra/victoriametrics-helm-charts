...
| defaultRules.rules.kubeApiserver | bool | `true` | Set to false to disable all API server alerting and recording rules |
| defaultRules.rules.kubeApiserverAvailability | bool | `true` | Enable Kubernetes API availability recording rules |
| defaultRules.rules.kubeApiserverBurnrate | bool | `true` | Enable Kubernetes API burnrate recording rules |
| defaultRules.rules.kubeApiserverHistogram | bool | `true` | Enable Kubernetes API historgram recording rules |
| defaultRules.rules.kubeApiserverSlos | bool | `true` | Enable Kubernetes API SLOS alerting rules |
...
| vmagent.spec.image.tag | string | `"v1.82.0"` |  |
...
| vmalert.spec.image.tag | string | `"v1.82.0"` |  |
...
| vmcluster.spec.vminsert.image.tag | string | `"v1.82.0-cluster"` |  |
...
| vmcluster.spec.vmselect.image.tag | string | `"v1.82.0-cluster"` |  |
...
| vmcluster.spec.vmstorage.image.tag | string | `"v1.82.0-cluster"` |  |
...
| vmsingle | object | `{"annotations":{},"enabled":true,"ingress":{"annotations":{},"enabled":false,"extraPaths":[],"hosts":["vmsingle.domain.com"],"labels":{},"path":"/","pathType":"Prefix","tls":[]},"spec":{"image":{"tag":"v1.82.0"},"replicaCount":1,"retentionPeriod":"14","storage":{"accessModes":["ReadWriteOnce"],"resources":{"requests":{"storage":"20Gi"}}}}}` | Configures vmsingle params |
